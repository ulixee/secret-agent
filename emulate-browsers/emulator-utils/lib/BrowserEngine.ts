...
import { validateHostRequirements } from '@secret-agent/browser-emulator-installer/lib/validateHostDependencies';
import { EngineFetcher } from '@secret-agent/browser-emulator-installer/lib/EngineFetcher';
import { IDataBrowserEngine } from '../interfaces/IBrowserData';
...
export default class BrowserEngine implements IBrowserEngine {
  ...
  constructor(pkg: any, { name, fullVersion, executablePathEnvVar }: IDataBrowserEngine) {
    this.pkg = pkg;
