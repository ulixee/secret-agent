...
} from "@secret-agent/browser-emulator-utils";

export default function loadDomOverrides(emulator: BrowserEmulatorBase, data: IBrowserData): DomOverridesBuilder {
  ...
  domOverrides.add('navigator', {
    ...
    headless: emulator.engine.isHeaded !== true,
  });
